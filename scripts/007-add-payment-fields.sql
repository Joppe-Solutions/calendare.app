-- Migration: Add payment fields for Asaas integration
-- Run this script on your Neon database

-- Add payment gateway configuration to businesses
...
-- Add payment configuration to services
...
-- Add subscription fields to businesses (if not exists)
ALTER TABLE businesses
